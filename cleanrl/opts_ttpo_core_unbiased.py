...
def select_next_states(
    ...
    if num_trees:
        ...
        sub_advantages = advantages[:n_steps, env_arr]
        ...
        discounts = (gamma * gae_lambda) ** flat_depths[valid_flat].to(dtype)
        successor_m[valid_flat] = root_values[valid_rows] + gae_lambda * (
